...
out.println("</nav>");
      ...
      out.println("Armstrong(num)<br>");
      out.println("1- n=num<br>");
      out.println("2- while(num>0) do<br>");
      out.println("3-   digit=n%10<br>");
      out.println("4-   sum=sum+pow(digit,3)<br>");
      out.println("5-   n=n/10<br>");
      out.println("6- if(sum==num)<br>");
      out.println("7-     print it is an armstrong number<br>");
      out.println("8- Else<br>");
      out.println("9-     print it is not an armstrong number<br></section></td><td>");
      ...
      out.println("Armstrong(num)");
      out.println("1- n=num");
      out.println("2- while(num>0) do");
      out.println("3-   digit=n%10");
      out.println("4-   sum=sum+pow(digit,3)");
      out.println("5-   n=n/10");
      out.println("6- if(sum==num)");
      out.println("7-     print it is an armstrong number");
      out.println("8- Else");
      out.println("9-     print it is not an armstrong number");
      ...
      out.println("O(n)");
      out.println("</fieldset>");
      out.println("<a href=armstrongvisual>Visualise</a>");
