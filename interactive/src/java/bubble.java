...
public class bubble extends HttpServlet 
{ int c=0;
  @Override
...
out.println("</nav>");
     out.println("<br><br>");   
      ...
      out.println("BUBBLE SORT<br>");
      out.println("1- declare i,j,temp<br>");
      out.println("2- for i<=1 to n <br>");
      out.println("3- for j<=1 to i <br>");
      out.println("4-    if a[j]>a[j+1]<br>");
      out.println("5-       swap a[j] and a[j+1]<br>");
      out.println("6-  End <br></section></td><td>");
       out.println("<section class=visual><div class=titulo>Validate and Visualise</div>");
      out.println("<form action=bubblevalidate method=post>");
     ...
     // out.println("<div class=olvido><div class=col><a href=registration title=Register Carasteres>Register</a></div>");
      ...
      out.println("<div class=olvido><div class=col><a href=bubblevisual align=center title=Visual Carasteres>Visualise</a></div>");
      out.println();
      ...
      out.println("<p align='center'>Bubble Sort Algorithm</p><hr color='red'>");
      
      out.println("<fieldset style='width: 400px; height: 200px;'><legend>Algorithm</legend>");
      out.println("1- declare i,j,temp");
      out.println("2- for i<=1 to n ");
      out.println("3- for j<=1 to i ");
      out.println("4-    if a[j]>a[j+1]");
      out.println("5-       swap a[j] and a[j+1]");
      out.println("6-  End ");
      ...
      out.println("O(n)");
      out.println("</fieldset>");
      out.println("<a href=bubblevisual>Visualise</a>");
      out.println("<fieldset style='width: 400px; height: 200px;'><legend>Validate</legend>");
      out.println("<form action=bubblevalidate method=post>");
      out.println("Enter Elements Array seperated by ,:<input type=text name=d1 /> ");
      ...
      else
      {
              ...
              res.sendRedirect("http://localhost:8084/interactive/bubble"); 
      }
  }
}