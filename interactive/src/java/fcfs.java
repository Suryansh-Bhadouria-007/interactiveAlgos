...
out.println("</nav>");
      ...
      out.println("FIRST COME FIRST SERVE<br>");
      out.println("1-Jobs are executed on first come, first serve basis.<br>");
      out.println("2-Easy to understand and implement.<br>");

      out.println("3-Poor in performance as average wait time is high.<br>");    
      out.println("<a href=fcfsvisual>Visualise</a>");
     ...
     out.println("FIRST COME FIRST SERVE");
      out.println("1-Jobs are executed on first come, first serve basis.");
      out.println("2-Easy to understand and implement.");

      out.println("3-Poor in performance as average wait time is high.");    
      out.println(" </fieldset>");
     
      out.println("<a href=fcfsvisual>Visualise</a>");
      out.println("<fieldset style='width: 400px; height: 150px;'><legend>Validate</legend>");
      out.println("<form action=fcfsvalidate method=post>");
