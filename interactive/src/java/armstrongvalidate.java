...
public class armstrongvalidate extends HttpServlet 
{  
   String n;
  ...
  {   
      ...
      if(n.equals(""))
      {
              ...
              res.sendRedirect("http://localhost:8084/interactive/armstrong");
      }   
      else
      {    
...
out.println("</nav>");
      ...
      if(num==sum)out.println("Number is an armstrong Number");
      else out.println("Number is not an Armstrong Number");
      d=0;sum=0;
      }
  }
}
