...
public class sjf extends HttpServlet 
{ int c=0;
  @Override
...
out.println("</nav>");
      ...
      out.println("SHORTEST JOB FIRST<br>");
      out.println("1-Best approach to minimize waiting time.<br>");
      out.println("2-Impossible to implement<br>");

      out.println("3-Processer should know in advance how much time process will take.<br>");    
     
    
     
      out.println("<a href=sjfvisual>Visualise</a>");
     ...
     out.println("SHORTEST JOB FIRST");
     out.println("1-Best approach to minimize waiting time.");
     out.println("2-Impossible to implement");

     out.println("3-Processer should know in advance how much time process will take.");  
      out.println(" </fieldset>");
     
      out.println("<a href=sjfvisual>Visualise</a>");
      out.println("<fieldset style='width: 400px; height: 150px;'><legend>Validate</legend>");
      out.println("<form action=sjfvalidate method=post>");
