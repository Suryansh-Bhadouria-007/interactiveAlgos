...
out.println("</nav>");
      ...
      out.println("0-1 KNAPSACK(m,w)");
      out.println("1-for j from 0 to W do");
      out.println("2-    m[0, j] := 0");
      out.println("3-for i from 1 to n do");
      out.println("4-  for j from 0 to W do");
      out.println("5-   if w[i] <= j then");
      out.println("6-      m[i, j] := max(m[i-1, j], m[i-1, j-w[i]] + v[i])");
      out.println("7-    else");
      out.println("8-      m[i, j] := m[i-1, j]");
      ...
      out.println("O(n)");
      out.println("</fieldset>");
      out.println("<a href=knapsackvisual>Visualise</a>");
      ...
      out.println("<form action=knapsackvalidate method=post>");
