...
public class fibonaccivalidate extends HttpServlet 
{  
   String n;
        int a=0,num=0,b=1,sum=0;
  ...
  {   
      ...
      if(n.equals(""))
      {
              ...
              res.sendRedirect("http://localhost:8084/interactive/fibonacci");
      }   
      else
      {
...
out.println("</nav>");
      ...
      if(num==0)out.println("Cannot Generate");
      else if(num==1)out.println("0");
      else
      {    out.println(a);
           out.println(b);
           for(int i=2;i<num;i++)
