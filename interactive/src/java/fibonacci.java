...
out.println("</nav>");
      ...
      out.println("Fibonacci(num)<br>");
      out.println("1- if(num==0)<br>");
      out.println("2-    print 0<br>");
      out.println("3- if(num==1)<br>");
      out.println("4-    print 1<br>");
      out.println("5- Else <br>");
      out.println("6-    a=1,b=1,sum=0 & print a,b<br>");
      out.println("7-    for(i=2;i<=num;i++)<br>");
      out.println("8-        sum=a+b & print sum<br>");
      out.println("9-        a=b & b=sum<br></section></td><td>");
      out.println("<section class=visual><div class=titulo>Validate and Visualise</div>");
      out.println("<form action=fibonaccivalidate method=post>");
      ...
      out.println("<div class=olvido><div class=col><a href=fibonaccivisual align=center title=Visual Carasteres>Visualise</a></div>");
      ...
      out.println("Fibonacci(num)");
      out.println("1- if(num==0)");
      out.println("2-    print 0");
      out.println("3- if(num==1)");
      out.println("4-    print 1");
      out.println("5- Else ");
      out.println("6-    a=1,b=1,sum=0 & print a,b");
      out.println("7-    for(i=2;i<=num;i++)");
      out.println("8-        sum=a+b & print sum");
      out.println("9-        a=b & b=sum");
      ...
      out.println("O(n)");
      out.println("</fieldset>");
      out.println("<a href=fibonaccivisual>Visualise</a>");
      out.println("<fieldset style='width: 400px; height: 200px;'><legend>Validate</legend>");
      out.println("<form action=fibonaccivalidate method=post>");
      out.println("Enter Number of terms:<input type=text name=d1 /> ");
