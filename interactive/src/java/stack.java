...
out.println("</nav>");
     out.println("<br><br>");   
      ...
      out.println("PUSH(STACK,TOP,MAX.ITEM)<br>");
      out.println("1- IF TOP=MAX THEN PRINT STACK OVERFLOW<br>");
      out.println("2- SET TOP:=TOP+1<br>");
      out.println("3- STACK[TOP]:=ITEM<br> ");
      out.println("4- END<br>");
      out.println();
      out.println("POP(STACK,TOP,ITEM)<br>");
      out.println("1-IF TOP=0 THEN PRINT UNDERFLOW<br>");
      out.println("2-ITEM:=STACK[TOP]<br>");
      out.println("3-SET TOP:=TOP-1<br>");
      out.println("END<br></section></td><td>");
       out.println("<section class=visual><div class=titulo>Validate and Visualise</div>");
      out.println("<form action=stackvalidate method=post>");
     ...
     // out.println("<div class=olvido><div class=col><a href=registration title=Register Carasteres>Register</a></div>");
      ...
      out.println(" <input type=submit name=b1 class=enviar value='Push' />");
      out.println("</form><form action=stackvalidate method=post>");
      out.println(" <input type=submit name=b1 class=enviar value='Pop' />");
      ...
      out.println("<p align='center'>Stack Implementation Algorithm</p><hr color='red'>");
      
      out.println("<fieldset style='width: 400px; height: 200px;'><legend>Algorithm</legend>");
      out.println("PUSH(STACK,TOP,MAX.ITEM)");
      out.println("1- IF TOP=MAX THEN PRINT STACK OVERFLOW");
      out.println("2- SET TOP:=TOP+1");
      out.println("3- STACK[TOP]:=ITEM ");
      out.println("4- END");
      out.println();
      out.println("POP(STACK,TOP,ITEM)");
      out.println("1-IF TOP=0 THEN PRINT UNDERFLOW");
      out.println("2-ITEM:=STACK[TOP]");
      out.println("3-SET TOP:=TOP-1");
      out.println("END");
      ...
      out.println("O(n)");
      out.println("</fieldset>");
      out.println("<a href=stackvisual>Visualise</a>");
      ...
      out.println("<input type=text name=d2 /> <input type=submit  name=b1 value='Push'/>");
      out.println("<p style=color:red>Field cannot be left empty</p>");
      out.println("<input type=submit name=b1 value='pop'>");
