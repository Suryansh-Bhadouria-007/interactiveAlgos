...
public class fifo extends HttpServlet 
{ int c=0;
  @Override
...
out.println("</nav>");
      ...
      out.println("FIRST IN FIRST OUT");
      out.println("1-select the page that has been in main memory the longest<br>");
      out.println("2-use a queue (data structure)<br>");

      out.println("3-problem: although a page has been present for a long time, it may be really useful<br>");    
     
     
      out.println("<a href=fifovisual>Visualise</a>");
     ...
     out.println("FIRST IN FIRST OUT");
      out.println("1-select the page that has been in main memory the longest");
      out.println("2-use a queue (data structure)");

      out.println("3-problem: although a page has been present for a long time, it may be really useful");    

      out.println(" </fieldset>");
     
      out.println("<a href=fifovisual>Visualise</a>");
      out.println("<fieldset style='width: 400px; height: 150px;'><legend>Validate</legend>");
      out.println("<form action=fifovalidate method=post>");
