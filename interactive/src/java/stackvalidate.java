...
public class stackvalidate extends HttpServlet 
{  
  ...
  {   
      ...
      push=req.getParameter("d2");
      button=req.getParameter("b1");
      ...
      if(button.equals("Push"))
       {
           //if(push.equals(""))
              ...
              //res.sendRedirect("http://localhost:8084/interactive/stack");
           //}
           //else
           //{   
...
out.println("</nav>");
     out.println("<br><br><br><br><br><br>");
          n=Integer.parseInt(push);
          if(count==5)out.println("Stack overflow");
          else arr[count++]=n;
...
out.println("</nav>");
     out.println("<br><br><br><br><br><br>");
          if(count==0)out.println("Stack underflow<br>");
          else out.println("Deleted element is "+arr[--count]+"<br>");
      }
      for(int i=count-1;i>=0;i--)out.println(arr[i]+"<br>");
  }
}  