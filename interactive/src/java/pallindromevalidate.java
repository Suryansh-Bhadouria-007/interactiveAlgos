...
public class pallindromevalidate extends HttpServlet 
{  
   String n;
        int c=0,num,m=0,sum=0,d=0;
  ...
  {   
      ...
      if(n.equals(""))
      {
              ...
              res.sendRedirect("http://localhost:8084/interactive/pallindrome");
      }   
      else
      {    
...
out.println("</nav>");
      ...
      if(num==sum)out.println("Number is a Pallindrome Number");
      else out.println("Number is not a Pallindrome Number");
      d=0;sum=0;
      } 
  }
}
