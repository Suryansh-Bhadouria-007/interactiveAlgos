...
public class prims extends HttpServlet 
{ int c=0;
  @Override
...
out.println("</nav>");
      ...
      out.println("PRIM(G,w,r)<br>");
      out.println("1- for each u<-V[G]<br>");
      out.println("2-     do key[u]<-infinity<br>");
      out.println("3-         parent[u]<-NIL<br>");
      out.println("4- key[r]<-0<br>");
      out.println("5- Q<-V[G]<br>");
      out.println("6- While(Q!=nil)<br>");
      out.println("7-    do u<-extract_min(Q)<br>");
      out.println("8-    for each v<-Adj[u]<br>");
      out.println("9-       do ifv<-Q and w(u,v)<key[v]<br>");
      out.println("10-         then parent[v]<-u<br>");
      out.println("11-              key[v]<-w(u,v)<br></section>");
     
      out.println("<a href=primsvisual>Visualise</a>");
      ...
      out.println("<p align='center'>Prim's Algorithm</p><hr color='red'>");
      
      out.println("<fieldset style='width: 400px; height: 400px;'><legend>Algorithm</legend>");
       out.println("PRIM(G,w,r)");
      out.println("1- for each u<-V[G]");
      out.println("2-     do key[u]<-infinity");
      out.println("3-         parent[u]<-NIL");
      out.println("4- key[r]<-0");
      out.println("5- Q<-V[G]");
      out.println("6- While(Q!=nil)");
      out.println("7-    do u<-extract_min(Q)");
      out.println("8-    for each v<-Adj[u]");
      out.println("9-       do ifv<-Q and w(u,v)<key[v]");
      out.println("10-         then parent[v]<-u");
      out.println("11-              key[v]<-w(u,v)");
      ...
      out.println("<form action=primsvalidate method=post>");
